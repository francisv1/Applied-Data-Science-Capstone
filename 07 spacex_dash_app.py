...
# TASK 2: Callback function to update pie chart based on dropdown selection
@app.callback(
...
# TASK 4: Callback function to update scatter chart based on dropdown and slider selection
@app.callback(
